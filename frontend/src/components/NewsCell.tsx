...
const NewsCell: React.FC<NewsCellProps> = ({ snapshot, source, onClick }) => {
  ...
  return (
    <div 
      className="relative rounded-lg overflow-hidden shadow-md hover:shadow-lg transition-all duration-300 transform hover:scale-[1.02] cursor-pointer h-48 bg-gray-100"
